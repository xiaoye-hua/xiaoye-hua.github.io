...
2. Optimization process
    1. First two term of Taylor expand was used for GBDT, while 3 was used in XBGoost objective function
...
5. Engineering: XGBoost is faster bacause parallel computing.
